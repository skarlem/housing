...
///	require(DIR_WS_FUNCTIONS . 'sessions.php');
	...
	// require(DIR_WS_CLASSES . 'BuildTree.php');
	// require(DIR_WS_CLASSES . 'wdPoints.php');
	// require(DIR_WS_CLASSES . 'Wallet.php');
	require(DIR_WS_CLASSES . 'Housing.php');
  ...
  if (session_status() == PHP_SESSION_NONE) { session_start(); ob_start(); }
  	...
  	if($_SESSION['userid'] != ''){
		...
		// $wdPoints = new wdPoints($_SESSION['userid']);
		// $wallet = new Wallet($_SESSION['userid']);
		$housing = new Housing($userID);
	}
